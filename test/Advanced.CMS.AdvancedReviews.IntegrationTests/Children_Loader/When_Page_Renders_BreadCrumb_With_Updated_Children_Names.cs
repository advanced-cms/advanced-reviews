...
public class When_Page_Renders_BreadCrumb_With_Updated_Children_Names(
    When_Page_Renders_BreadCrumb_With_Updated_Children_Names.TestFixture fixture)
    : IClassFixture<CommonFixture>, IClassFixture<When_Page_Renders_BreadCrumb_With_Updated_Children_Names.TestFixture>,
        IClassFixture<WithGetChildrenOverride>
{
    ...
    public async Task Get_Children_Call_Returns_Unpublished_Content_Items()
    {
        ...
        Assert.Contains(StaticTexts.UpdatedString, reviewHtmlNodeWithChildren.InnerText);
    }
}
