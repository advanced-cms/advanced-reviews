...
declare module "advanced-cms-approval-reviews/advancedReviewService" {
...
declare module "advanced-cms-external-reviews/external-review-service" {
...
interface ExternalReviewService {
    ...
    edit(token: string, validto: Date, pinCode: string, displayName: string, visitorGroups: string[]): Promise<any>;
}
